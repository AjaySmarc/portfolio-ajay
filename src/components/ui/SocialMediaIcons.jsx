...
const socialMediaLinks = [
    {
        url: 'https://www.linkedin.com/in/ajay-mudettula',
        iconComponent: <FaLinkedin className="fill-white hover:fill-secondary" size={25} />
    },
    {
        url: 'https://github.com/AjaySmarc',
        iconComponent: <FaGithub className="fill-white hover:fill-secondary" size={25} />
    },
    {
        url: 'https://leetcode.com/u/ajay_mudettula/',
        iconComponent: <FaJava className="fill-white hover:fill-secondary" size={25} />
    },
];

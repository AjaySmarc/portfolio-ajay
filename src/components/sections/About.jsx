        ...
        <section className="mt-5 max-w-4xl mx-auto md:px-8" id="about">
            ...
            <div className="text-secondary-text md:flex flex-row gap-16 px-4 md:px-0" ref={ref}>
                <motion.div
                    ...
                    <p className="pb-3">
                    Hey there! I`m Ajay, a passionate developer based in Hyderabad. I specialize in MERN stack development, building scalable and efficient web applications. While my core expertise lies in full-stack development, I`m always eager to learn and adapt to new technologies as per project needs.
                    </p>
...
{/*                     <div className="pb-3">
                    ...
                    <div className="pb-3">
                    I`m looking for new opportunities where I can merge my love for coding with continuous learning to solve challenging problems. If you have an opening that aligns with my skills, let`s connect and explore the possibilities!
                    </div>
                </motion.div>

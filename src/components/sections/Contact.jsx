...
const Contact = () => {
  ...
  const handleSendMessage = async (event) => {
    ...
    if (response.ok) {
      setFormData({ user_email: '', user_subject: '', user_message: '' });
    }
...
const contactData = [
  {
    ...
    info: 'majayyadav1357@gmail.com',
    path: 'mailto:majayyadav1357@gmail.com',
  },
  {
    title: 'LinkedIn',
    icon: <FaLinkedin size={24} />,
    info: '@ajay-mudettula',
    path: 'https://www.linkedin.com/in/ajay-mudettula',
  },
  // {
  //     title: "LeetCode",
  //     icon: <FaJava size={24} />,
  //     info: "@ajay_mudettula",
  //     path: "https://leetcode.com/u/ajay_mudettula/"
  // },
];
